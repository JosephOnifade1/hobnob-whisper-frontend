...
-- First change default, then alter column type
ALTER TABLE public.image_generations ALTER COLUMN status SET DEFAULT 'pending'::generation_status;
ALTER TABLE public.image_generations ALTER COLUMN status TYPE generation_status USING status::generation_status;
